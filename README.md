...
4. **Placement:** Follow the [website placement guidance](publishing/website-placement.md) to make sure visitors can find your information.

## Contributing

We welcome contributions of new templates, examples, and improvements to the framework. See [CONTRIBUTING.md](community/contribute.md) for details.
